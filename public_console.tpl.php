...
<div id="wrapper">
	...
	<div id="user">
		<div>
			<label>Name: </label>
			<span id="activeName"><?=$_SESSION['authenticated_user']['name']?></span>
		</div>
		<div>
			<label>License No.:</label>
			<span id="activeLiNo"><?=$_SESSION['authenticated_user']['licence_num']?></span>
		</div>
	</div>
	<div class="content">
		<div class="contentinner">
			...
			<a href="" id="menu"><div>
				<h3>Change Vehicle Registration</h3>
			</div></a>
			<a href="" id="menu"><div>
				<h3>Request Sticker</h3>
			</div></a>
			<a href="" id="menu"><div>
